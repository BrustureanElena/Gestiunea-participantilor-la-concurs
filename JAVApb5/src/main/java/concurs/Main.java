...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        ParticipantRepository participantiDBRepository=new ParticipantiDBRepository(props);
       ...
       // participantiDBRepository.add(new Participant("Balaie","Paul",2));
        ...
        ProbaRepository probaDBRepository=new ProbaDBRepository(props);
     //   probaDBRepository.add(new Proba("cautarea unei comori",4,5));
       ...
       // for(Proba p1:probaDBRepository.findAllByDenumire("cautarea unei comori"))
        ...
        InscriereRepository inscriereDBRepository=new InscriereDBRepository(props,participantiDBRepository
        ,probaDBRepository);
   ...
   //     inscriereDBRepository.add(inscriere4);
        ...
        AngajatOficiuRepository angajatiOficiuDBRepository=new AngajatiOficiuDBRepository(props);
