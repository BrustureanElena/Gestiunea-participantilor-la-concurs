import concurs.network.protobuffprotocol.ConcursProtobufs;
import concurs.network.utils.AbstractServer;
import concurs.network.utils.ConcursConcurrentServer;
import concurs.network.utils.ConcursProbuffConcurrentServer;
...
public class StartProtobuffServer {
    ...
    public static void main(String[] args) {
        ...
        AbstractServer server = new ConcursProbuffConcurrentServer(chatServerPort, concursServiceImpl);
        try {
            server.start();
